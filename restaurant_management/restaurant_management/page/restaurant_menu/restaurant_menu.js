...
//         /* Optional: Veg / Non Veg / Beverage badge */
//         .badge {
...
//         .Veg { background: #27ae60; } /* green */
//         .Non\ Veg { background: #e74c3c; } /* red */
//         .Beverage { background: #3498db; } /* blue */
//     </style>`;
...
//         callback:r=>render_menu(r.message)
//     });
// }
...
//                 html += `
//                 <div class="menu-card"
//                      onclick="open_order_dialog('${item.name}','${item.item_name}',${item.standard_rate})">
//                     <b>${item.item_name}</b>
...
// function open_create_order_dialog(table_name, data) {
...
//                 fieldtype:"Link",
//                 options:"Customer",
//                 default:data.reservation_customer || ""
//             },
//             {
//                 label:"Items",
//                 fieldname:"items",
