...
def create_custom_fields():
	...
	path = os.path.join(os.path.dirname(__file__), "restaurant_management/custom_fields")
...
def create_property_setter():
	...
	path = os.path.join(os.path.dirname(__file__), "restaurant_management/property_setter")
	for file in os.listdir(path):
		with open(os.path.join(path, file), "r") as f:
			args = json.load(f)
			PPS.update(args)
